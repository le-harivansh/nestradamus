...
export class ForgotPasswordService {
  ...
  async sendOtpEmail(destination: string) {
    ...
    return this.mailService.queueSend(
      ...
      {
        path: '_authentication/_forgot-password/template/forgot-password.mail.mjml.hbs',
        variables: {
          email: destination,
  ...
  async sendPasswordResetEmail(destination: string) {
    ...
    return this.mailService.queueSend(
      ...
      {
        path: '_authentication/_forgot-password/template/password-reset.mail.mjml.hbs',
        variables: {
          email: destination,
        },
      },
