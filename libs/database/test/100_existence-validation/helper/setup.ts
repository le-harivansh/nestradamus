...
import { UserIdTestController } from './controller/user-id-test.controller';
import { UsernameTestController } from './controller/username-test.controller';
...
export async function setupTestApplication() {
  ...
  @Module({
    ...
    controllers: [UserIdTestController, UsernameTestController],
